...
CompassDirection -> w_obj "l‰nsi"
		    with door_dir w_to, name 'l//' 'l‰nsi' 'l‰nt' 'l‰nteen' 'l‰nti';
...
CompassDirection -> in_obj "sis‰puolella"
		    with door_dir in_to, name 'sis‰‰n' 'sis‰' 'sis‰puole';
...
Constant ME3__WD        = 'itse‰';	!!! miksei 'itseƒ' toimi
!Constant ME4__WD	= 'itse‰';	!!! esim.: 'tutki itse‰', 'minua'
Constant OF1__WD        = 'of';
Constant OF2__WD        = 'of';
Constant OF3__WD        = 'of';
Constant OF4__WD        = 'of';
...
[ LanguageLM n x1;
  ...
  EmptyT: switch (n) {
	1:  print_ret (k_nominatiivi) x1, " ei toimi s‰iliˆn‰.";
 ...
 ListMiscellany: switch (n) {
  ...
  Lock: switch (n) {
	...
	2:  print_ret (ksejane) x1, " ", (eijaeivat) x1, " ole lukossa t‰ll‰ hetkell‰.";
...
!            print " to "; PrintCommand(); print "?^";
        ...
        49: print "Mit‰ haluat"; ! mit‰, mill‰, mihin, mille jne...
            if (actor ~= player) print " ", (the) actor;
            print " "; PrintCommand(); print "?^";
...
! Yksikkˆ JA monikko?
	...
	6:  print (k_nominatiivi) x1; if (x1 has pluralname) print " ovat tyhji‰."; else print " on tyhj‰.";
  ...
  Take: switch (n) {
	...
	10: if (x1 has pluralname) print "Ne eiv‰t taida olla siirrett‰viss‰."; 
		else print "Se ei taida olla siirrett‰viss‰.";                     !?! Kannettava?
