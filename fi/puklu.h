...
[ LanguageRefers obj wnum adr len end w csID; 
	...
	{ #Ifdef DEBUG;	if (parser_trace >= 5) debugsijat(wnum, len, end, w, csID);#Endif;
	    ...
	    else if (csID == 0 or 1 or 3 or 6 or 10)  !yksikkˆ ja nom, par, ess tai ill
		rtrue; 
	};
...
#Endif;
	    ...
	    else if (csID ~= 0 or 1 or 3 or 6 or 10)  !yksikkˆ ja ei nom, par, ess tai ill
		rtrue; 
	};
	!! esim. vahva_b 'maukka' 'maukkaa' 
	!! (kaikki paitsi yksikˆn nominatiivi 'maukka' + partitiivip‰‰te 'ta' kelpaa)
